...
import ru.ancientempires.campaign.points.ScriptSetNamedPoint;
...
import ru.ancientempires.reflection.PointOffset;
...
public class CampaignEditor
{
	...
	public void dfs(ScriptContainer container)
	{
		...
		if (game.path != null && "campaign.6".equals(game.path.gameID))
			if (container.script instanceof ConditionBoolean)
				System.out.println(container.script.hashCode());
	...
	*/
	...
	public void convert(int iMission2) throws IOException
	{
