...
public class FileHelper
{
	...
	public FileHelper(FileHelper fileHelper, String prefix)
	{
		baseDirectory = fileHelper.baseDirectory;
		assets = fileHelper.assets;
		this.prefix = fileHelper.prefix + prefix;
	}
	...
	public FileHelper getLoader(String name)
	{
		return new FileHelper(this, name);
	}
